...
/**
 * handles the adding and removing of files on a menu, usually the "File" menu.
 * It will place them between the two separators with attribute "name"
 * respectively : "separatorFiles" ( originally not visible) and "separatorExit"
 * followed by a menu Item used to clear the Recent File list. These are usually
 * placed just above the Exit menu item. See code below:
 * <p>
...
public class MenuUtility {
	...
	/**
	 * Adds a JMenuItem to the menu's recent Files list with the file's absolute
	 * path for the text. Returns the new menu item so that an action listener can
	 * be added by the calling class
	 * 
	 * @param menu
	...
	public static JMenuItem addFileItem(JMenu menu, File file, ActionListener listener) {
		return addFileItem(menu, file, new JMenuItem(), listener);
	 ...
	 * @param newMenu
	 *                    - the type of menu item (JMenuItem/JCheckBoxMenuItem) that
	 *                    will be created
	 * @return
	 */
	public static JMenuItem addFileItem(JMenu menu, File file, JMenuItem newMenu, ActionListener listener) {
	 ...
	 *                    (JMenuItem/JCheckBoxMenuItem/JRadioButtonMenuItem) that
	 *                    will be created - for JRadioButtonMenuItems manage the
	 *                    ButtonGroup in the callining class.
	...
	/**
	 * Clears the recent File list and sets visible false for Separator
	 * Start,Separator End, and menu clearRecentFiles
	 * 
	 * @param menu
	...
	/**
	 * returns an ArrayList with all the file paths currently Selected on the Recent
	 * File List
	 * 
	 * @param menu
	 *                 the menu that contains the recent File List
	 * @return an ArrayList<String> of the full paths of the files Selected on the
	 *         Recent File List
	 */
	...
	/**
	 * returns an ArrayList with all the file paths currently on the Recent File
	 * List
	 * 
	 * @param menu
	 *                 the menu that contains the recent File List
	 * @return an ArrayList<String> of the full paths of the files on the Recent
	 *         File List
	 */
	...
	/**
	 * save to the calling class' Preference fiel the count of file on the File List
	 * and the fullPaths of the fiels
	 * 
	 * @param myPrefs
	 *                    A node in a hierarchical collection of preference data
	 *                    used by the calling class
	 * @param menu
	...
	/**
	 * Uses the calling class'sPreference loads the saved file onto the Receent File
	 * List
	 * 
	 * @param myPrefs
	 *                    A node in a hierarchical collection of preference data
	 ...
	 */
	public static void loadRecentFileList(Preferences myPrefs, JMenu menu, ActionListener listener) {
		...
		for (int i = 0; i < fileCount; i++) {
			...
			addFileItem(menu, new File(myPrefs.get(key, "NO FILE")), listener);
		} // for each path
